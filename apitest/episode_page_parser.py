...
def parse_episode_page(url: str) -> dict:
    ...
    return {
        ...
        "novel_title": element_text(novel_link),
        "novel_url": absolute_url(novel_link.get("href"), url) if novel_link else None,
        "author_name": element_text(author_link),
        "author_url": absolute_url(author_link.get("href"), url) if author_link else None,
